...
public class ToStringDataCallRootNode extends RootNode {

    @Child public NoraNode arg1;
    @Child public NoraNode arg2;
    @Child public DataToStringNode body;

    public ToStringDataCallRootNode(NoraNode arg1, NoraNode arg2, DataToStringNode body) {
    ...
    public Object execute(VirtualFrame frame) {
        try {
            ...
            body.executeToString((TruffleStringBuilder) builder,data);
            return null;
    ...
    @Override
    public ToStringDataCallRootNode cloneUninitialized() {
        CompilerAsserts.neverPartOfCompilation();
        return new ToStringDataCallRootNode(arg1.cloneUninitialized(), arg2.cloneUninitialized(), body.cloneUninitialized());
    }
